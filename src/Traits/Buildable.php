...
trait Buildable
{
    ...
    public function decrement($column, $amount = 1, array $extra = [], array $options = []) {
        ...
        return parent::decrement($column, $amount, $extra, $options);
    }
    ...
    public function increment($column, $amount = 1, array $extra = [], array $options = []) {
        ...
        return parent::increment($column, $amount, $extra, $options);
    }
    ...
    public function paginate(
        ...
        $columns = collect($columns)->toArray();
        $cacheKey = $this->makeCacheKey($columns, null,
            "-paginate_by_{$perPage}_{$pageName}_{$page}");
